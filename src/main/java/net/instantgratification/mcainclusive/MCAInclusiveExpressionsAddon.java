...
public class MCAInclusiveExpressionsAddon implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        LOGGER.info("[MCA Inclusive Expressions Addon] Initialized v4.4.18+26.2.");
    }

    /**
     * Calculates natural anatomical Y-position sag (+0.25f max at 4.44x scale, moving DOWNWARD) based on breast size scale.
     */
    public static float calculateAutoYSag(float breastSizeScale) {
        ...
        return 0.25f * Math.min(1.0f, Math.max(0.0f, norm));
    }
